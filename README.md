...
for testUser.cpp -> g++ testUser.cpp User.cpp InvoiceSystem.cpp PricingCalculator.cpp TicketSystem.cpp Vehicle.cpp ParkingLot.cpp ParkingSlot.cpp -o testUser.exe
