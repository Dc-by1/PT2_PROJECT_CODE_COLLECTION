...
// utility function: Capitalizes and remove spaces from original plate input
string Vehicle::formatPlateNumber(string oriPlate) const {
    string newPlate = "";
...
// Returns the hourly parking rate based on whether the type is a Car or Motorcycle
